...
*
* ConsumerGroupApp
This source file contains the basic code needed to consume
 records from one or many Apache Kafka topics. In contrast
  to assigning individual partitions as in the ConsumerApp.java file,
   this class subscribes to topics passed to the subscribe() method as a list of strings.
   The functionality for printing the subscribed topics and the retrieved records is provided and
    is similar to the capabilities in the ConsumerApp.java file.
